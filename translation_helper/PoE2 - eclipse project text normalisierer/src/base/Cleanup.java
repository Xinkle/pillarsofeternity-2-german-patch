...
public class Cleanup {
    ...
    public static void main(String[] args) throws JAXBException, SAXException, IOException {
        File stringtableSchema = new File("..\\..\\translation_helper\\stringtable.xsd");
        ...
        List<Path> filesInFolder = Files.walk(Paths.get("..\\..\\exported\\localized\\de_patch\\text\\")).filter(Files::isRegularFile).sorted().collect(Collectors.toList());
        filesInFolder.addAll(Files.walk(Paths.get("..\\..\\laxa_exported\\localized\\de_patch\\text\\")).filter(Files::isRegularFile).sorted().collect(Collectors.toList()));
        filesInFolder.addAll(Files.walk(Paths.get("..\\..\\laxb_exported\\localized\\de_patch\\text\\")).filter(Files::isRegularFile).sorted().collect(Collectors.toList()));
        filesInFolder.addAll(Files.walk(Paths.get("..\\..\\laxc_exported\\localized\\de_patch\\text\\")).filter(Files::isRegularFile).sorted().collect(Collectors.toList()));

        List<Path> compareFilesInFolder = Files.walk(Paths.get("E:\\Games\\Steam\\steamapps\\common\\Pillars of Eternity II\\PillarsOfEternityII_Data\\exported\\localized\\ko\\text\\")).filter(Files::isRegularFile).sorted().collect(Collectors.toList());
        compareFilesInFolder.addAll(Files.walk(Paths.get("E:\\Games\\Steam\\steamapps\\common\\Pillars of Eternity II\\PillarsOfEternityII_Data\\laxa_exported\\localized\\ko\\text\\")).filter(Files::isRegularFile).sorted().collect(Collectors.toList()));
        compareFilesInFolder.addAll(Files.walk(Paths.get("E:\\Games\\Steam\\steamapps\\common\\Pillars of Eternity II\\PillarsOfEternityII_Data\\laxb_exported\\localized\\ko\\text\\")).filter(Files::isRegularFile).sorted().collect(Collectors.toList()));
        compareFilesInFolder.addAll(Files.walk(Paths.get("E:\\Games\\Steam\\steamapps\\common\\Pillars of Eternity II\\PillarsOfEternityII_Data\\laxc_exported\\localized\\ko\\text\\")).filter(Files::isRegularFile).sorted().collect(Collectors.toList()));


        List<Path> compareFilesENInFolder = Files.walk(Paths.get("E:\\Games\\Steam\\steamapps\\common\\Pillars of Eternity II\\PillarsOfEternityII_Data\\exported\\localized\\en\\text\\")).filter(Files::isRegularFile).sorted().collect(Collectors.toList());
        compareFilesENInFolder.addAll(Files.walk(Paths.get("E:\\Games\\Steam\\steamapps\\common\\Pillars of Eternity II\\PillarsOfEternityII_Data\\laxa_exported\\localized\\en\\text\\")).filter(Files::isRegularFile).sorted().collect(Collectors.toList()));
        compareFilesENInFolder.addAll(Files.walk(Paths.get("E:\\Games\\Steam\\steamapps\\common\\Pillars of Eternity II\\PillarsOfEternityII_Data\\laxb_exported\\localized\\en\\text\\")).filter(Files::isRegularFile).sorted().collect(Collectors.toList()));
        compareFilesENInFolder.addAll(Files.walk(Paths.get("E:\\Games\\Steam\\steamapps\\common\\Pillars of Eternity II\\PillarsOfEternityII_Data\\laxc_exported\\localized\\en\\text\\")).filter(Files::isRegularFile).sorted().collect(Collectors.toList()));
        ...
        List<Path> convertingBase = Files.walk(Paths.get("F:\\Work\\Java\\pillarsofeternity-2-Enhanced-UI\\PoE2-EnhancedUserInterface\\localized\\en\\text\\")).filter(Files::isRegularFile).sorted().collect(Collectors.toList());

        filesInFolder = Files.walk(Paths.get("E:\\Games\\Steam\\steamapps\\common\\Pillars of Eternity II\\PillarsOfEternityII_Data\\exported\\localized\\ko\\text\\")).filter(Files::isRegularFile).sorted().collect(Collectors.toList());
        cleanup.colorupdate(convertingBase, filesInFolder, "ko", jaxbUnmarshaller,marshaller);

//        filesInFolder = Files.walk(Paths.get("E:\\Games\\Steam\\steamapps\\common\\Pillars of Eternity II\\PillarsOfEternityII_Data\\exported\\localized\\en\\text\\")).filter(Files::isRegularFile).sorted().collect(Collectors.toList());
//        cleanup.colorupdate(convertingBase, filesInFolder, "en2", jaxbUnmarshaller,marshaller);
//
//        filesInFolder = Files.walk(Paths.get("..\\..\\exported\\localized\\de_patch\\text\\")).filter(Files::isRegularFile).sorted().collect(Collectors.toList());
//        cleanup.colorupdate(convertingBase, filesInFolder, "de_patch", jaxbUnmarshaller,marshaller);
//
//        filesInFolder = Files.walk(Paths.get("E:\\Games\\Steam\\steamapps\\common\\Pillars of Eternity II\\PillarsOfEternityII_Data\\exported\\localized\\fr\\text\\")).filter(Files::isRegularFile).sorted().collect(Collectors.toList());
...
//        filesInFolder = Files.walk(Paths.get("E:\\Games\\Steam\\steamapps\\common\\Pillars of Eternity II\\PillarsOfEternityII_Data\\exported\\localized\\it\\text\\")).filter(Files::isRegularFile).sorted().collect(Collectors.toList());
//        cleanup.colorupdate(convertingBase, filesInFolder, "it2", jaxbUnmarshaller,marshaller);
//
//        filesInFolder = Files.walk(Paths.get("E:\\Games\\Steam\\steamapps\\common\\Pillars of Eternity II\\PillarsOfEternityII_Data\\exported\\localized\\es\\text\\")).filter(Files::isRegularFile).sorted().collect(Collectors.toList());
//        cleanup.colorupdate(convertingBase, filesInFolder, "es", jaxbUnmarshaller,marshaller);
//
//        filesInFolder = Files.walk(Paths.get("E:\\Games\\Steam\\steamapps\\common\\Pillars of Eternity II\\PillarsOfEternityII_Data\\exported\\localized\\pt\\text\\")).filter(Files::isRegularFile).sorted().collect(Collectors.toList());
//        cleanup.colorupdate(convertingBase, filesInFolder, "pt", jaxbUnmarshaller,marshaller);
//
//        filesInFolder = Files.walk(Paths.get("E:\\Games\\Steam\\steamapps\\common\\Pillars of Eternity II\\PillarsOfEternityII_Data\\exported\\localized\\pl\\text\\")).filter(Files::isRegularFile).sorted().collect(Collectors.toList());
...
//
//        filesInFolder = Files.walk(Paths.get("E:\\Games\\Steam\\steamapps\\common\\Pillars of Eternity II\\PillarsOfEternityII_Data\\exported\\localized\\zh\\text\\")).filter(Files::isRegularFile).sorted().collect(Collectors.toList());
...
//                                        outputFile.getEntries().add(damageDefenseIconEntry);
//                                    } else {
//                                        outputFile.getEntries().add(damageIconEntry);
//                                    }
                                } else {
...
//                                        outputFile.getEntries().add(damageDefenseIconEntry);
                                ...
                                if(coloredEntry != null && (damageIconEntry != null || damageDefenseIconEntry != null)) {
                                    ...
                                    outputFile.getEntries().add(booth);
                                } else if(damageDefenseIconEntry != null){
                                    outputFile.getEntries().add(damageDefenseIconEntry);
                                } else if(damageIconEntry != null) {
                                    outputFile.getEntries().add(damageIconEntry);
                                } else {
                                    outputFile.getEntries().add(coloredEntry);
                                }
                    ...
                    File file = new File("C:\\Repositories\\pillarsofeternity-2-Enhanced-Ui\\localized\\" + language + "\\text\\game\\" + plain.getFileName());
